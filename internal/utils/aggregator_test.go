...
type UsageData struct {
	...
	Accelerator_model_name             string `dataframe:"accelerator_model_name,string"`
	Accelerator_profile_name           string `dataframe:"accelerator_profile_name,string"`
	Accelerator_frame_buffer_usage_min string `dataframe:"accelerator_frame_buffer_usage_min,float"`
	Accelerator_frame_buffer_usage_max string `dataframe:"accelerator_frame_buffer_usage_max,float"`
	Accelerator_frame_buffer_usage_avg string `dataframe:"accelerator_frame_buffer_usage_avg,float"`
	Tensor_pipe_active_min             string `dataframe:"tensor_pipe_active_min,float"`
	Tensor_pipe_active_max             string `dataframe:"tensor_pipe_active_max,float"`
	Tensor_pipe_active_avg             string `dataframe:"tensor_pipe_active_avg,float"`
	Dram_active_min                    string `dataframe:"dram_active_min,float"`
	Dram_active_max                    string `dataframe:"dram_active_max,float"`
	Dram_active_avg                    string `dataframe:"dram_active_avg,float"`
	Sm_active_min                      string `dataframe:"sm_active_min,float"`
	Sm_active_max                      string `dataframe:"sm_active_max,float"`
	Sm_active_avg                      string `dataframe:"sm_active_avg,float"`
}
