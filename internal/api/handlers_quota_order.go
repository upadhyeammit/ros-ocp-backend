...
var quotaAllowedOrderBy = map[string]string{
	...
	"utilization":               `GREATEST(COALESCE(cpu_request_utilization_bp,0), COALESCE(cpu_limit_utilization_bp,0), COALESCE(memory_request_utilization_bp,0), COALESCE(memory_limit_utilization_bp,0))`,
...
var clusterQuotaAllowedOrderBy = map[string]string{
	...
	"utilization":               `GREATEST(COALESCE(utilization_cpu_request_percent,0), COALESCE(utilization_memory_request_percent,0))`,
