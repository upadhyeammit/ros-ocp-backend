...
2. CI runs `scripts/generate-docs.sh` which:
   - Generates API reference markdown from Go source via `gomarkdoc`
   - Copies `docs/known-issues.md` → `docs-site/known-issues.md`
   - Copies `CONTRIBUTING.md` → `docs-site/contributing.md`
   - Copies select `docs/features/*.md` → `docs-site/features/`
...
|---|---|---|
| `docs/known-issues.md` | `docs-site/known-issues.md` | Copied by `generate-docs.sh` |
| `CONTRIBUTING.md` | `docs-site/contributing.md` | Copied (with path rewrites) |
| `docs-site/features/virtual-machines.md` | Same path | Hand-maintained (`.gitignore` exception) |
| `docs-site/features/index.md` | Same path | Hand-maintained (force-added) |
| `docs-site/whats-new.md` | Same path | Hand-maintained (force-added) |
| Go source (`internal/plugins/*/`) | `docs-site/plugin-reference/*.md` | Generated by `gomarkdoc` |

### .gitignore rules

`docs-site/` directories that contain generated files are gitignored:

```gitignore
docs-site/architecture/       # copied from docs/architecture/
docs-site/operations/         # copied from docs/operations/
docs-site/features/           # copied from docs/features/
docs-site/known-issues.md     # copied from docs/known-issues.md
docs-site/contributing.md     # copied from CONTRIBUTING.md
```
