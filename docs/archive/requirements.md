...
| `ROS_ENABLE_VM_RECS` | false | VM recommendations (removed; see ADR-0157) |
...
2. **Per-capability feature flags** (see §22b, Risk Resolution R17):
   - `ROS_USE_OOM_FEEDBACK`, `ROS_ENABLE_GPU_RECS`, `ROS_ENABLED_PLUGINS`/`ROS_DISABLED_PLUGINS`, etc. (`ROS_ENABLE_VM_RECS` removed; see ADR-0157)
