...
| NUMA node memory (GiB) <br><em>Single-node memory cap for NUMA fit check (63) until operator exposes topology.</em> | 64 | `ROS_VM_NUMA_NODE_MEMORY_GIB` | `PUT /settings/vm` | `placement.numa_node_memory_gib` | Yes |
