...
| Document | Scope |
|----------|-------|
| [phase-0-critical-fixes.md](plans/phase-0-critical-fixes.md) | Phase 0: Critical bug fixes |
| [phase-1-2-3-go-engine.md](plans/phase-1-2-3-go-engine.md) | Phases 1-3: Core Go engine, metrics pipeline, decay weighting |
| [phase-4-oom-feedback.md](plans/phase-4-oom-feedback.md) | Phase 4: Memory algorithm with OOM feedback |
| [phase-4-pr-checklist.md](plans/phase-4-pr-checklist.md) | Phase 4: PR checklist |
